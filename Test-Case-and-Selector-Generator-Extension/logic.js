...
export const stepTemplates = {
    click: (label, menuName = '') => `${insertMenu('Click On', label, menuName)}`,
    enter: (label, value, menuName = '') => `${insertMenu('Enter', label, menuName)} "${value}"`,
    select: (label, value, menuName = '') => `${insertMenu('Select', label, menuName)} "${value}"`,
};
